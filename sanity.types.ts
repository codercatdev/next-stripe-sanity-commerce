...
export type AllSanitySchemaTypes = StripeSession | Cart | Collection | Product | Price | Post | Author | Settings | SanityAssistInstructionTask | SanityAssistTaskStatus | SanityAssistSchemaTypeAnnotations | SanityAssistOutputType | SanityAssistOutputField | SanityAssistInstructionContext | AssistInstructionContext | SanityAssistInstructionUserInput | SanityAssistInstructionPrompt | SanityAssistInstructionFieldRef | SanityAssistInstruction | SanityAssistSchemaTypeField | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Query: *[_type == "product"]{    _id,    name,    description,    "slug": slug.current,    "price": default_price->.unit_amount,    "image": images[0].asset->,  }
...
// Query: *[_type == "product" && slug.current == $slug][0]{    _id,    name,    description,    "slug": slug.current,    "price": default_price->.unit_amount,    "image": images[0].asset->,    "priceId": default_price->.stripePriceId,    }
...
export type CartByIdQueryResult = {
  items: Array<{
